...
//void draw_char1(char x, char y, char c, unsigned int colour, char size) {
//    int i, j;
//    char line;
...
//void draw_datetime(char x, char y, unsigned int colour, char size, uint8_t *datetime) {
//
//    //Work out the size of each character
//    int char_width = size * 5;
//    //Iterate through each character in the string
//    int counter = 0;
//    while(datetime[counter] != '\0') {
//        //Calculate character position
//        int char_pos = x + (counter * char_width);
//        //Write char to the display
//        draw_char1(char_pos, y, datetime[counter], colour, size);
//        //Next character
//        counter++;
//    }
//}
 ...
 */
/*void draw_bitmap(int x, int y, int scale, const uint8_t *bmp){
	int width = bmp[0];
	int height = bmp[1];
	 uint8_t this_byte;
